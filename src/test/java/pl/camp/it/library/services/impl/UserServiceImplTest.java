...
public class UserServiceImplTest {
    ...
    public void setUpMocks() {
        ...
        Mockito.when(userDAO.getUserByLogin("mateusz")).thenReturn(user);
        ...
        Mockito.when(userDAO.getUserByLogin("admin")).thenReturn(user);
    ...
    public void wrongPasswordAuthenticationTest() {
        /*Mockito
                ...
                .thenReturn(generateUser("mateusz", "jasydf", 5));*/
        User user = new User();
        user.setLogin("mateusz");
        user.setPassword("jasghdfjhga");
    ...
    public void correctAuthenticationTest() {
        ...
        Mockito.when(this.userDAO.getUserByLogin("mateusz")).thenReturn(new User());
        Mockito.when(this.userDAO.getUserByLogin("admin")).thenReturn(new User());*/
        User user = new User();
        user.setLogin("admin");
